<?php require_once("cann.php");
   ...
   if (isset($_POST["daddy"])){
    ...
    $yearr = mysqli_real_escape_string($conn, $_POST["yearr"]);
       $newtable = $monthh.$yearr.'l'.$coopidd;
       $new=$monthh.$yearr;
       $link1 ='generateloans.php?mont='.$new;
      
$tracy = mysqli_query($conn,"select * from lonrec where monthyr ='$newtable'");
...
$mysqlu2 = mysqli_query($conn, "INSERT INTO lonrec (monthyr) VALUES ('$newtable')"); 
    echo'<script type="text/javascript"> 
...
<head>
        ...
        <title>Bulk monthly loan repayment</title>
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">Generate monthly bulk loan repayment</h3>
								<ul class="breadcrumb">
								 <li class="breadcrumb-item"><a href="lntemp.php">Edit/confirm loan template first</a></li>
