...
// 87e25944099a7715a8350f1bf1851107
 ...
 echo '<script type ="text/javascript">alert("please do not submit empty form."")</script>';}
   ...
   $mysqlu = mysqli_query($conn, "INSERT INTO memberi (staffid, sname, onames, dob, fon, email, hpazz, dept, rank, datereg, level, balance, msave, titl, djoin, hemail) VALUES ($staffid, '$sname', '$onames', '$dob', '$fon', '$email', '87e25944099a7715a8350f1bf1851107', '$dept', '$rank', '$date_reg', '$level', $balance, $msave, '$titl', '$djoin', '$hemail')"); 
...
<head>
        ...
        <title>Add new member <?php echo 
 echo $staffid.''.$titl.''.$djoin.''.$sname.''.$onmaes.''.$fon.''.$email.''.$dept.''.$rank.''.$level.''.$balance.''.$msave.''.$dob;?></title>
