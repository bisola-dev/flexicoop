<?php require_once("cann.php");
  ...
  $memmem = mysqli_query($conn, "SELECT * FROM memberz WHERE hemail= '$hmalx' AND coopid= $coopidd");
							...
							<div class="card-group m-b-30">
								...
								<div class="card">
									<div class="card-body">
										<div class="d-flex justify-content-between mb-3">
											<div>
												<span class="d-block">Balance CF</span>
											</div>
											 
										</div>
										<h3 class="mb-3"><?php echo $balak; ?></h3>
										<div class="progress mb-2" style="height: 5px;">
											<div class="progress-bar bg-primary" role="progressbar" style="width: 70%;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
										</div>
									</div>
								...
								<div class="card">
									<div class="card-body">
										<div class="d-flex justify-content-between mb-3">
											<div>
												<span class="d-block">Total monthly</span>
											</div>
											 
										</div>
										<h3 class="mb-3"><?php echo $mysaf; ?></h3>
										<div class="progress mb-2" style="height: 5px;">
											<div class="progress-bar bg-primary" role="progressbar" style="width: 70%;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
										</div>
									</div>
