...
if (isset($_POST['clikloan'])){
  ...
  $mysqlu2 = mysqli_query($conn, "UPDATE basik SET elig = $eligx, colet = $coletx, maxloan = $maxloanx, gara = $garax, lpay = $lpayx WHERE coopid = $coopidd"); 
  ...
  echo'<script type="text/javascript"> 
    ...
    $resultt = mysqli_query($conn, "SELECT * FROM basik WHERE coopid = $coopidd");
