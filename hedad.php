  ...
  <div class="header">
                ...
                <div class="header-left">
                    <a href="dashboardad.php" class="logo">
						<img src="imgg/<?php echo $logozz;?>" width="40" height="40" alt="">
					</a>
                </div>
				<!-- /Logo -->
                ...
                <div class="page-title-box">
					...
					<h3><?php if (!empty( $cname)){echo $cname;} ?></h3>
                </div>
				<!-- /Header Title -->
				
				<a id="mobile_btn" class="mobile_btn" href="#sidebar"><i class="fa fa-bars"></i></a>
				<?php  
					$resup = mysqli_query($conn, "SELECT * FROM memberz WHERE msg > 0 AND dele = 0");
