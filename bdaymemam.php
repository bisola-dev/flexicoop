<?php require_once("cann.php");
  ...
  $memmem = mysqli_query($conn, "SELECT * FROM memberz WHERE bday = '$tomonth' AND coopid= $coopidd");    
    ...
    <body>
        ...
        <div class="main-wrapper">
		 			...
		 			$nobday = "NO BIRTHDAY TODAY";
          			...
          			while ($row=mysqli_fetch_assoc($memmem)) {
                            ...
                            $pixx =$row['pix'];
                             $deptx =$row['dept'];
                            $activ1 =$row['activ'];
                       $editm = 'editmem.php?id='.$idx.'&hid='.$hidx;
			...
			<?php } ?>
				...
				<!-- /Page Content -->
			<div class="container-fluid" style="text-align: center; color: red;">
                	<h3><?php if (!empty( $nobday)){echo $nobday;} ?></h3>
                </div>
