...
$allowTypes = array('jpg','png','jpeg');
 if (!in_array($fileType, $allowTypes)){
      ...
      $insert= mysqli_query($conn, "UPDATE basik SET logoz = '$fileName', coopid= $coopidd WHERE cmal = '$mymal'");
    ...
    $fitt = mysqli_query($conn, "SELECT * FROM basik where cmal='$mymal'");
 	while ($row=mysqli_fetch_assoc($fitt)) {
                            $logozz =$row['logoz'];
						 ...
						 <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
							<div class="profile-widget">
								<div class="profile-img">
									<a href="#" class="avatar"><img src="imgg/<?php echo $logozz;?>" alt=""></a>
								</div>
