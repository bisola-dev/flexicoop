  ...
  //    echo 'DEBE';              
            //session variables
                ...
                $mymalx =$_SESSION['mymal'] = $uzer;
                 $coopidd =$_SESSION['copid'] = $coppd;
                 $gegeto = mysqli_query($conn, "SELECT * FROM basik WHERE coopid = '{$coppd}'");
                 while ($row=mysqli_fetch_assoc($gegeto)) {
     			$cnammy = $row['cname'];
     			$logoz1 = $row['logoz'];
				}
				$logozz =$_SESSION['logu'] = $logoz1;
                $coopname =$_SESSION['coop'] = $cnammy;
				 ...
				 /Account Logo -->
					...
					<div class="account-box">
						<div class="account-wrapper">
							<h3 class="account-title">Member's Login</h3>
