...
// 87e25944099a7715a8350f1bf1851107
 ...
 echo '<script type ="text/javascript">alert("please do not submit empty form."")</script>';}
   ...
   $mysqlu = mysqli_query($conn, "UPDATE basik SET cname = '$cname2', cmal = '$cmal2', cfon = '$cfon2', addy = '$addy2', coopid= $coopidd WHERE cmal = '$mymal'"); 
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
					 ...
					 <div class="form-group row">
											...
											<div class="col-md-10">
											 <input type="text" name="cname" value=" <?php if (!empty($cname)){echo $cname;} ?>" class="form-control" required>
											</div>
										</div>
					...
					<div class="form-group row">
											...
											<div class="col-md-10">
												<input type="email" name="cmal" value="<?php if (!empty( $cmal)){echo $cmal;} ?>" class="form-control" required>
											</div>
										</div>
					 ...
					 <div class="form-group row">
											...
											<div class="col-md-10">
												<input type="number" name="cfon" value="<?php if (!empty( $cfon)){echo $cfon;} ?>" class="form-control" required>
											</div>
										</div>
					 ...
					 <div class="form-group row">
											...
											<div class="col-md-10">
												<input type="text" name="addy" value="<?php if (!empty( $addy)){echo $addy;} ?>" class="form-control" required>
											</div>
										</div>
